---
title: Cancellation Insights for Subscription Businesses
...
{{<rawhtml>}}
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
        ...
        <div class="order-2 col-span-2 xl:col-span-3 flex-col">
            <img src='img/cancellation-reasons-hero.png' class="rounded-lg shadow-2xl" alt="" />
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
            ...
            <h2 class="text-gray-800 text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 lg:mb-8">
                    Collect a reason for 100% of cancellations
                </h2>
                <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                    Stripe Customer Portal cancellation reason collection is broken. Our solution lets you:
                    <ul>
                    <li class="border rounded-lg py-4 px-8 bg-white mb-6">Collect a cancellation reason <span>before</span> a customer cancels.</li>
                    <li class="border rounded-lg py-4 px-8 bg-white">Easily export cancellation data to a spreadsheet.</li>
                    </ul>
                </p>                
            </div>
            <div class="order-1 md:order-2 col-span-2 xl:col-span-3">
                <img src='img/cancellation-reasons-modal.png' class="rounded-lg shadow-2xl" alt="" />
            </div>
        </div>
    </div>
...
<div class="py-12 md:py-24 pb-12 lg:pb-16 bg-gray-100">
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
            <div class="order-1 col-span-2 xl:col-span-3 self-center">
                <img src='img/cancellation-reason-dashboard.png' class="rounded-lg shadow-2xl" alt="" />
                
            </div>
            <div class="order-2 col-span-2 mt-12 md:mt-0">
                <h2 class="text-gray-800 text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 lg:mb-8">
                    Understand why customers are cancelling and fix it
                </h2>
                <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                    Customers cancel because something changes. Cancellation reason collection helps you find out why. Check the reasons month by month and watch for changes to fix issues before they become a bigger problem.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
            ...
            <h2 class="text-gray-800 text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 lg:mb-8">
                ...
                <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                    Select the reasons you want to collect and customize the text that will be displayed to your customers.
                </p>                
            </div>
            <div class="order-1 md:order-2 col-span-2 xl:col-span-3">
                <img src='img/cancellation-reason-custom.png' class="rounded-lg shadow-2xl" alt="" />
            </div>
        </div>
    </div>
