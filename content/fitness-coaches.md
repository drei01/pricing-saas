---
title: Stripe Customer Portal for Fitness Coaches
date: 2020-12-01T14:54:28+01:00
draft: false
type: page
description: Fitness Coach Stripe Customer Portal - Let your customer manage their subscription without writing code
---
{{<rawhtml>}}
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
        <div class="order-1 col-span-2 self-center my-12 md:my-0">
            <h1 class="text-gray-800 text-3xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4 lg:mb-8">
                Manually updating Customer's Stripe subscriptions? <br/> <br/> Let them manage their own.
            </h1>
        ...
        <div class="order-2 col-span-2 xl:col-span-3 flex-col">
            <img src='img/coaches/gym-coach.jpg' class="rounded-lg shadow-2xl" alt="" />
...
{{<partial "testimonials">}}
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
            ...
            <h2 class="text-gray-800 text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 lg:mb-8">
                    Let customers manage their subscription directly from your website, <br/> or use ours
                </h2>
                <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                    Simply send your customers a link to your website and they can manage their exiting Stripe subscription by entering their email address. Got no website? No worries, we'll provide you a link to send your customers.
                </p>                
            </div>
            <div class="order-1 md:order-2 col-span-2 xl:col-span-3">
                <img src='img/coaches/thetraininglab.png' class="rounded-lg shadow-2xl" alt="screenshot of thetraininglab.com" />
            </div>
        </div>
    </div>
...
<div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 py-12 lg:py-16 xl:py-24">
    <div class="text-center mb-6 md:mb-8">
        <h2 id="pricing" class="text-black text-3xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4">Grow your fitness business with our tailored pricing</h2>
