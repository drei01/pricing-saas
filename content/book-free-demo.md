...
{{<rawhtml>}}
    ...
    <div class="mt-10">
      <div class="space-y-10 md:space-y-0 grid grid-cols-1 md:grid-cols-2 md:gap-x-8 md:gap-y-10">
        ...
        <ul class="pt-8">
            <li class="flex">
                <svg class="h-6 w-12 fill-current" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"><path d="m1299 813-422 422q-19 19-45 19t-45-19L493 941q-19-19-19-45t19-45l102-102q19-19 45-19t45 19l147 147 275-275q19-19 45-19t45 19l102 102q19 19 19 45t-19 45zm141 83q0-148-73-273t-198-198-273-73-273 73-198 198-73 273 73 273 198 198 273 73 273-73 198-198 73-273zm224 0q0 209-103 385.5T1281.5 1561 896 1664t-385.5-103T231 1281.5 128 896t103-385.5T510.5 231 896 128t385.5 103T1561 510.5 1664 896z"/></svg>
                </svg>
                <div class="pl-4">
                    <h3 class="text-xl font-bold">Learn How Your Business Can Use PriceWell</h3>
                    <p class="pt-4">
                    We don't follow any scripts. You get a complete demo personalized to your business. You tell us what you want to achieve and we'll share how to do it. We'll even tell you if we're not a good fit.
                    </p>
                </div>
            </li>
            <li class="flex pt-4">
                ...
                <div class="pl-4">
                    ...
                    <p class="pt-4">
                    We can write over and over how simple PriceWell is to use. But the best way is to see for your self. We'll show you step-by-step how to get started so you can start collecting/managing subscription payments through your website.
                    </p>
                </div>
            </li>
            <li class="flex pt-4">
                ...
                <div class="pl-4">
                    ...
                    <p class="pt-4">
                    Not everyone is a technical wiz so we are here to help every step of the way. We've helped hundreds of businesses just like yours. We'll schedule as many follow up calls as you need. After all, your success is our success.
                    </p>
                </div>
            </li>
        </ul>
