---
title: Stripe Customer Portal for Agencies
date: 2020-12-01T14:54:28+01:00
draft: false
type: page
description: The easiest way for Web Agencies to let their Customers update their billing information and manage their subscription.
---
{{<rawhtml>}}
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
        ...
        <div class="order-2 col-span-2 xl:col-span-3 flex-col">
            <img src='img/customer-portal-agency.png' class="rounded-lg shadow-2xl" alt="" />
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
            ...
            <h2 class="text-gray-800 text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 lg:mb-8">
                ...
                <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                    As a digital agency you probably have customers in Stripe. You can use PriceWell to let them manage their subscription without writing any code. The Stripe Customer Portal is fully customizable and can be embedded in your website or app.
                </p>                
            </div>
...
<div class="py-12 md:py-24 pb-12 lg:pb-16 bg-gray-100">
    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
            ...
            <h2 class="text-gray-800 text-2xl md:text-3xl lg:text-4xl font-bold mb-2 md:mb-4 lg:mb-8">
                ...
                <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                    Join our <a href="https://pricewell.getrewardful.com/signup">Affiliate Program</a> and earn <b>20%</b> of the revenue generated when your clients use PriceWell.
                </p>                
            </div>
            <div class="order-1 md:order-2 col-span-2 xl:col-span-3">
                <img src='images/affiliate-program.png' class="rounded-lg shadow-2xl" alt="" />
            </div>
        </div>
    </div>
...
<div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 py-12 lg:py-16 xl:py-24">
    <div class="text-center mb-6 md:mb-8">
        <h2 id="pricing" class="text-black text-3xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4">Grow your agency with our tailored pricing</h2>
