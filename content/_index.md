    ...
    <div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 grid md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
        <div class="order-2 md:order-1 col-span-2 self-center mt-12 md:mt-0">
            ...
            <p class="text-lg xl:text-xl text-gray-600 mb-6 lg:mb-8 xl:mb-10">
                Build a pricing page in seconds, get more customers, and never worry about payments again.
            </p>
...
<div class="py-12 lg:pb-16">
    <h2 class="w-full text-center font-bold">Integrated with</h2>
    <div
...
<div class="max-w-screen-xl mx-auto px-6 lg:px-8 xl:px-4 mb-12 lg:mb-16 xl:mb-24">
    <div class="flex flex-col justify-center items-center">
        ...
        >
            <div>
                <p class="trakcing-wide uppercase font-bold text-gray-700 text-lg lg:text-xl">4.9 Overall rating</p>
